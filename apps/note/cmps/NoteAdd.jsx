    ...
    return (
        <form className="note-form" onSubmit={onAddNote}>
            <div className="input-container">
                ...
                {selectedOption === 'todo' && (<div>
                    <label htmlFor="title">Title</label>
                    <input onChange={handleChange} type="text" name="title" value={noteToAdd.title} id="title" /><br />
                    <label htmlFor="text">Text</label>
                    <input onChange={handleChangeTodo} type="text" name="txt" value={noteToAdd.info.todo} id="text" />

                </div>)}

            </div>
            <button className="note-form-button" onClick={onAddNote} >Add note </button>
